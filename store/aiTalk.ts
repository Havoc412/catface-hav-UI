...
export const aiTalk = defineStore("aiTalkContent", {
      ...
      history: [
        {
          ...
          content: [
            {
              type: "text",
              text: "小主人！萧萧在这里为您推荐了一些热门旅游城市，有您喜欢的吗？",
            },
            {
              type: "CG-spot",
              list: [
          ...
          content: [
            {
              ...
              text: "黄鹤楼",
              introduce:
                "作为武汉的地标，黄鹤楼不仅是历史悠久的古建筑，还能远眺长江美景。",
              grade: 4.8,
              location: "武昌区蛇山西山坡特2号",
              price: 70,
              imgPath: "/static/example/spot/spot-1.png",
            },
            {
              type: "IB-spot",
              text: "东湖风景区",
              ...
              location: "武昌区鲁磨路665号",
              price: 55,
              imgPath: "/static/example/spot/spot-2.png",
              // ...
            },
            {
              type: "IB-spot",
              ...
              location: "武昌区八一路299号",
              price: 0,
              imgPath: "/static/example/spot/spot-3.png",
            },
            {
              type: "IB-spot",
              text: "户部巷",
              ...
              location: "武昌区八一路299号",
              price: 0,
              imgPath: "/static/example/spot/spot-4.png",
            },
            {
              type: "IB-spot",
              text: "江汉路步行街",
              introduce:
                "这里有很多购物和娱乐场所，是体验武汉现代都市生活的好地方。",
              grade: 4.7,
              location: "武昌区八一路299号",
              price: 0,
              imgPath: "/static/example/spot/spot-5.png",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              text: "小主人！萧萧已经为您制定好了基础规划，点击右侧悬浮窗可以查看规划细节。",
            },
            { type: "endl" },
            { type: "text", text: "第一天：" },
            {
  ...
  actions: {
    ...
    addAiMessage(content: String) {
      ...
      if (this.loadingClear) this.history[index]["content"].push(aiMessage);
      else {
        this.history[index]["content"] = [aiMessage];
