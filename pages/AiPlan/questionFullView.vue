...
<script setup>
    ...
    // com
    import position from "./question-sub/position.vue";
    import timeView from "./question-sub/time.vue";
    import preference from "./question-sub/preference.vue";
    import budget from "./question-sub/budget.vue";
    import individualTag from "./question-sub/individualTag.vue";
    // store
